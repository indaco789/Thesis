...
\subsection{6.2. Sistemi legacy, database ed Event
Sourcing}\label{sistemi-legacy-database-ed-event-sourcing}
...
\begin{figure}
\centering
\includegraphics[width=1.00000\textwidth]{../images/legacy-kafka.png}

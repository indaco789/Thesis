...
Apache Avro è un formato per la serializzazione di dati che si divide in
due parti: i \emph{dati} e lo \emph{schema dei dati}.
...
che possono essere visionate nella documentazione di Apache Avro:

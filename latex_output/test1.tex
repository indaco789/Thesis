...
cambiamenti nell'ambito dei processi di ETL\footnote{Narkhede N.
  \emph{ETL Is Dead, Long Live Streams: Real-Time Streams with Apache
  Kafka}, www.youtube.com/watch?v=I32hmY4diFY}.\\
...
\small
[a] Narkhede N. and Shapira G. and Palino T. (2017), \emph{Kafka: The
Definitive Guide: Real-Time Data and Stream Processing at Scale},
O'Reilly Media Inc.

{[}b{]} Kleppmann M. (2016), \emph{Making Sense of Stream Processing},
O'Reilly Media Inc.
...
{[}1{]} Wikipedia contributors. (2018), \emph{Microservices},\\
https://en.wikipedia.org/wiki/Microservices\#History

{[}2{]} \_What is ETL?\_,\\
https://www.sas.com/en\_us/insights/data-management/what-is-etl.html

{[}4{]} Wikipedia contributors. (2018), \emph{Extract, transform,
load},\\
https://en.wikipedia.org/wiki/Extract,\_transform,\_load

{[}3{]} Koshy J. (2016), \emph{Kafka Ecosystem at LinkedIn},\\
https://engineering.linkedin.com/blog/2016/04/kafka-ecosystem-at-linkedin

{[}c{]} Martin F. \emph{Event Sourcing},\\
https://martinfowler.com/eaaDev/EventSourcing.html

{[}d{]} Wikipedia contributors. (2018), \emph{Event store},\\
https://en.wikipedia.org/w/index.php?title=Event\_store\&oldid=824633488

{[}{]} Narkhede N. \emph{ETL Is Dead, Long Live Streams: Real-Time

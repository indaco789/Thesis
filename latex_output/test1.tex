...
\begin{figure}
\centering
\includegraphics[width=0.50000\textwidth]{../images/log.png}
...
sequenza di operazioni di modifica dello stato eseguite partendo da uno
stato iniziale, questo implica che è possibile vedere un evento come il
delta tra lo stato iniziale di una applicazione e lo stato di arrivo
dell'applicazione all'avvenire del evento.\\
...
\begin{figure}
\centering
\includegraphics[width=0.50000\textwidth]{../images/streams-table-duality.jpg}
...
\caption{esempio\_es \label{figure_3}}
\end{figure}

...
cui sono stati inviati posizionandoli in fondo al log, inoltre non sono
modificabili o cancellabili.\\
Un consumer legge i messaggi di un topic partendo dalla testa del log
proseguendo fino alla coda.
...
la \emph{i link cliccati in una pagina}, \emph{quali pagine sono state
